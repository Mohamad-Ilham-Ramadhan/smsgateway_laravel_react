...
class GroupContactShow extends Component {
						...
						<table className="table table-group table-bordered table-striped table-hover table-sm">
							...
							<tbody>
								{/*% for autoreply in autoreplies %*/}
									<tr>
										<th scope="row"> groupContact.id </th>
										<td> groupContact.namaPasien </td>
										<td> groupContact.noTelpon </td>
...
export default GroupContactShow;
