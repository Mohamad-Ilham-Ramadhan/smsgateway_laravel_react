            ...
            <div className="row pt-4 position-relative" id="tooltipContainer">
				<div className="col">
					<Card
						...
						title="Data User"
						extra={
							<Link to="/users/create" className="btn btn-primary btn-sm btn-rounded float-right" data-toggle="tooltip" data-placement="top" data-original-title="Add"><i className="fas fa-plus"></i></Link>
						}
						footer={
						...
						<table className="table table-group table-bordered table-striped table-hover table-sm">
							<thead>
								<tr>
									...
									<th scope="col">Level Privilege</th>
							...
							<tbody>
								{/*% for autoreply in autoreplies %*/}
									<tr>
										...
										<td> users.noTelepon </td>
										<td> users.levelPrivilege </td>
